...
let resetPlayers = () => {
    ...
    for(const k of Object.keys(game.players)) {
        Object.assign(game.players[k], defaultPlayer)
        if(k % 2 === 0) {
            game.players[k].teamId += 1
        }
    }
}
...
io.on('connection', (client) => {
    ...
    let evaluateTrick = () => {
        ...
        const winningTeamId = game.players[parseInt(bestPlayerId)].teamId
